                ...
                for (i = 0;i < nready;i ++) {
                    ...
                    if (result.event == EVENT_ACCEPT) {
                        ...
                        if (ret == 0) {
                            ...
                            kv_request<conn_item>(this->connect_list[clientfd]);
                            this->connect_list[clientfd].wlen = strlen(this->connect_list[result.fd].wbuffer);

                            set_event_send(result.fd, connect_list[clientfd].wbuffer, connect_list[clientfd].wlen, 0);
                        }
